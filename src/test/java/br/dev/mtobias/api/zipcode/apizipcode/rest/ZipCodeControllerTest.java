...
//
//    private ZipCodeDTO requestZipCode(CountryServiceEnum country, String zip) {
//        String url = getUrlFromZipCode(country.getCode(), zip);
...
//        ZipCodeDTO forObject = requestZipCode(CountryServiceEnum.BRAZIL, ZIP_CODE_BR_SUCCESS_SEND);
...
//        assertThat(getRestTemplate()).isNotNull();
//        ZipCodeDTO forObject = requestZipCode(CountryServiceEnum.BRAZIL, ZIP_CODE_BR_INVALID_SEND);
...
//        assertThat(getRestTemplate()).isNotNull();
//        ZipCodeDTO forObject = requestZipCode(CountryServiceEnum.PORTUGAL,ZIP_CODE_PT_SUCCESS_SEND);
...
//        assertThat(getRestTemplate()).isNotNull();
//        ZipCodeDTO forObject = requestZipCode(CountryServiceEnum.PORTUGAL,ZIP_CODE_PT_INVALID_SEND);
//        assertThat(forObject).isNull();
//    }
